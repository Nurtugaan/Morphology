"""
RoBERTa-base Training Script for English Morphological Analysis

Скрипт обучения модели RoBERTa-base для морфологического анализа.
...
С параметрами:
    python -m services.training.models.train_roberta --epochs 5 --batch-size 32
"""
...
MODEL_SHORT_NAME = "roberta-base"
OUTPUT_DIR = "services/models/en/roberta-base"

# Recommended hyperparameters for RoBERTa-base
# RoBERTa often benefits from slightly lower learning rate
DEFAULT_CONFIG = {
